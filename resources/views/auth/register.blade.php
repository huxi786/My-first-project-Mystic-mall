...
<div class="split-screen">
    ...
    <div class="left-pane">
        <div class="auth-container">
            <div class="brand-logo-mobile text-center">
                <img src="{{ asset('images/logo-icon-gold.png') }}" alt="Mystic Mall Logo" style="height: 60px; width: auto; filter: drop-shadow(0 4px 10px rgba(255, 215, 0, 0.4));">
            </div>
    ...
    <div class="right-pane">
        ...
        <div class="brand-content d-flex flex-column align-items-center">
            <img src="{{ asset('images/logo-icon-gold.png') }}" alt="Mystic Mall Logo" style="height: 140px; margin-bottom: 20px; filter: drop-shadow(0 10px 30px rgba(255, 215, 0, 0.5));">
