            ...
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $product->id }}</td>
                        <td>
                            <img src="{{ Str::startsWith($product->image, 'http') ? $product->image : asset('uploads/' . $product->image) }}" alt="{{ $product->name }}" class="rounded shadow-sm" width="50" height="50" style="object-fit: cover;">
                        </td>
