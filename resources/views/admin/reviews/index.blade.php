                            ...
                            <tr>
                                <td class="ps-4">
                                    <div class="d-flex align-items-center">
                                        @if($review->product)
                                            <img src="{{ Str::startsWith($review->product->image, 'http') ? $review->product->image : asset('uploads/' . $review->product->image) }}" alt="Img" class="rounded me-2" width="40" height="40" style="object-fit: cover;">
                                            <div>
