                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="bg-light rounded p-2 me-3 text-muted">
                                                            @if(isset($details['image']))
                                                                <img src="{{ Str::startsWith($details['image'], 'http') ? $details['image'] : asset('uploads/' . $details['image']) }}" alt="{{ $details['name'] }}" width="50" height="50" class="rounded" style="object-fit:cover;">
                                                            @else
