...
<body>
    ...
    <div class="sidebar">
        <div class="sidebar-brand d-flex flex-column align-items-center justify-content-center">
            <img src="{{ asset('images/logo-icon-gold.png') }}" alt="Mystic Admin Logo" style="height: 60px; width: auto; margin-bottom: 12px; filter: drop-shadow(0 4px 10px rgba(255, 215, 0, 0.6));">
            <span style="font-size: 1.1rem; letter-spacing: 2px;">Mystic Admin</span>
        </div>
